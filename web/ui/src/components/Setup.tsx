    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
                  ...
                  [
                    {
                      ...
                      icon: ComputerIcon,
                      title: "Standalone",
                      desc: "Just this machine. You can cluster later.",
                    },
                    {
        ...
        {step === "password" && (
          <>
            <CardHeader>
              <CardTitle>Name and secure this machine</CardTitle>
              <CardDescription>
                The name shows up wherever this node appears in the cluster.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form
          ...
          <>
            <CardHeader>
              ...
              <CardDescription className="text-center">
                Here&apos;s your swarm code. Add workers now or whenever — you
        ...
        {step === "restarting" && (
          <>
            <CardHeader className="text-center">
              ...
              <CardTitle>Restarting as worker</CardTitle>
              <CardDescription>
                Hiro will reconnect to the leader automatically. This page will
                refresh when it&apos;s ready.
              </CardDescription>
            </CardHeader>
          </>
        )}
