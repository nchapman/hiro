...
var toolStatusMessages = map[string]string{
	...
	"spawn_instance":  "Spawning {{agent}}",
	"resume_instance": "Resuming instance",
	"stop_instance":   "Stopping instance",
	"delete_instance": "Deleting instance",
	"list_instances":  "Listing instances",
	"send_message":    "Messaging instance",
	"persona_read":  "Reading persona",
	"persona_write": "Writing persona",
