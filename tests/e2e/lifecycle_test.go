...
func TestE2E_SessionClear(t *testing.T) {
	...
	cs.chat(ctx, `Send a message to the instance named "lifecycle-clear" telling it: "Use memory_write to save 'favorite_color: purple'. Then use the todos tool to create one task: 'test session clear'." Report what it said.`)
